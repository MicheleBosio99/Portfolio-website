...
const Sidebar: React.FC = () => {
  return (
    <aside className="sidebar">
      ...
      <p className="occupation">Software Engineer and<br/>Data Scientist</p>
      
      <div className="sidebar-divider"></div>
      
      <div className="social-links">
        <div className="contact-info">
          <a className="contact-item" href="mailto:micberbos@gmail.com" aria-label="Email">
            {/* Mail */}
          ...
          <a className="contact-item" href="https://wa.me/393460699395" aria-label="WhatsApp">
            {/* Phone */}
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <a className="contact-item" href="https://maps.app.goo.gl/Pj9MpuBm9Rr8RaWd9" aria-label="Location">
            {/* Location */}
            <svg viewBox="0 0 24 24" fill="currentColor">
